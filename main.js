...
$('select[data-menu]').each(function() {
    ...
    options.each(function(i) {
        ...
        if(option.text() === 'Unknown' || option.text() === 'Bald' || option.text() === 'Multicolored' || option.text() === 'Dichromatic' || option.text() === 'Hazel' || option.text() === 'BRAUNGRÜNBLAU') {
        	...
        	let colorr = '';
        	if(option.text() === 'BLK') {colorr = "#222931";  }
        	if(option.text() === 'Blond') {colorr = "rgb(237, 237, 45)"; }
        	if(option.text() === 'Brown') {colorr = "rgba(120, 0, 0, 0.617)"; }
        	if(option.text() === 'Gray') {colorr = "gray"; }
        	if(option.text() === 'Sandy') {colorr = "sandybrown"; }
        	if(option.text() === 'Red') {colorr = "rgb(235, 39, 39)"; }
        	if(option.text() === 'Blue') {colorr = "rgb(65, 65, 212);"; }
        	if(option.text() === 'Green') {colorr = "rgb(51, 178, 51)"; }
        	if(option.text() === 'Maroon') {colorr = "rgb(117, 0, 0)"; }
        	if(option.text() === 'Pink') {colorr = "rgb(227, 132, 159)"; }
        	if(option.text() === 'Red') {colorr = "rgb(235, 39, 39)"; }

          if(option.text() === 'BLAU') {colorr = "rgb(65, 65, 212)"; }
          if(option.text() === 'BRAUN') {colorr = "rgba(120, 0, 0, 0.617)"; }
          if(option.text() === 'BLAU-GRAU') {colorr = "#6A5ACD"; }
          if(option.text() === 'GRAU-BLAU') {colorr = "#5a819b"; }
          if(option.text() === 'GRAUGRÜN') {colorr = "#71b378"; }
          if(option.text() === 'GRÜNBRAUN') {colorr = "#6c7453"; }
          if(option.text() === 'GRÜN-BRAUN') {colorr = "#426d6d"; }
          if(option.text() === 'GRÜN') {colorr = "#44de87"; }
          if(option.text() === 'BLAUGRAU') {colorr = "#6A5ACD"; }
          if(option.text() === 'GRAU-GRÜN-BLAU') {colorr = "#008080"; }
          if(option.text() === 'GRAU-GRÜN') {colorr = "#71b378"; }


          if(option.text() === 'ALBASTRI-BLUE') {colorr = "rgb(65, 65, 212)"; }
          if(option.text() === 'VERZI-GREEN') {colorr = "rgba(44, 165, 92, 0.617)"; }
          if(option.text() === 'CĂPRUI-BROWN') {colorr = "rgba(120, 0, 0, 0.617)"; }
          if(option.text() === 'GRI-GRAY') {colorr = "#6c7453"; }
          if(option.text() === 'NEGRI-BLACK') {colorr = "#000"; }
          if(option.text() === 'HAZEL') {colorr = "rgb(218, 175, 0)"; }

          if(option.text() === 'Brązowy') {colorr = "#8B4513"; }
          if(option.text() === 'Zielony') {colorr = "#228B22"; }
          if(option.text() === 'Szary') {colorr = "#808080"; }
          if(option.text() === 'Czarny') {colorr = "#000000"; }
          if(option.text() === 'Piwne') {colorr = "#DAA520"; }
          if(option.text() === 'Niebieskozielony') {colorr = "#20B2AA"; }
          if(option.text() === 'Miodowy') {colorr = "#C19A6B"; }
          if(option.text() === 'Lazurowy') {colorr = "#ADD8E6"; }
...
$(document).on('click', '.select-menu > ul > li', function(e) {
    ...
    if(select.attr('id') === 'hairColorId') {
    	if(index == 0 || index == 7) { colorrr = '#989A9F';}
    	if(index == 1) { colorrr = '#222931';}
    	if(index == 2) { colorrr = 'rgb(237, 237, 45)';}
    	if(index == 3) { colorrr = 'rgba(120, 0, 0, 0.617)';}
    	if(index == 4) { colorrr = 'gray';}
    	if(index == 5) { colorrr = 'sandybrown';}
    	if(index == 6) { colorrr = 'rgb(235, 39, 39)';}
    	$('#svgselecticon > path').css('fill', colorrr);
    }

    if(select.attr('id') === 'eyeColorId') {
    	if(index == 3) { colorrr = '#5a819b';}
    	if(index == 0) { colorrr = 'rgb(65, 65, 212)';}
    	if(index == 1) { colorrr = 'rgba(120, 0, 0, 0.617)';}
    	if(index == 2 || index == 9) { colorrr = '#6A5ACD';}
    	if(index == 4 || index == 11) { colorrr = '#71b378';}
    	if(index == 5) { colorrr = '#6c7453';}
    	if(index == 6) { colorrr = '#2E425B';}
    	if(index == 7) { colorrr = '#426d6d';}
    	if(index == 8) { colorrr = '#44de87';}
    	if(index == 10) { colorrr = '#008080';}
    	$('#svgselecticon1 > path').css('fill', colorrr);
    }

    if(select.attr('id') === 'eyeColorIdRom') {
    	if(index == 0) { colorrr = 'rgb(65, 65, 212)';}
    	if(index == 1) { colorrr = 'rgba(44, 165, 92, 0.617)';}
    	if(index == 2) { colorrr = 'rgba(120, 0, 0, 0.617)';}
    	if(index == 3) { colorrr = '#6c7453';}
    	if(index == 4) { colorrr = '#000';}
    	if(index == 5) { colorrr = 'rgb(218, 175, 0)';}
    	$('#svgselecticon2 > path').css('fill', colorrr);
    }

    if(select.attr('id') === 'eyeColorIdFrance') {
    	if(index == 0) { colorrr = '#0000FF';}
    	if(index == 1) { colorrr = '#008000';}
    	if(index == 2) { colorrr = '#0a803b';}
    	if(index == 3) { colorrr = '#8B4513';}
    	if(index == 4) { colorrr = '#6B8E23';}
    	if(index == 5) { colorrr = '#D2691E';}
    	if(index == 6) { colorrr = '#808080';}
    	if(index == 7) { colorrr = '#000000';}
    	if(index == 8) { colorrr = '#A52A2A';}
    	$('#svgselecticon3 > path').css('fill', colorrr);
    }

    if(select.attr('id') === 'eyeColorRPoland') {
    	if(index == 0) { colorrr = '#8B4513';}
    	if(index == 1) { colorrr = '#228B22';}
    	if(index == 2) { colorrr = '#808080';}
    	if(index == 3) { colorrr = '#000000';}
    	if(index == 4) { colorrr = '#DAA520';}
    	if(index == 5) { colorrr = '#20B2AA';}
    	if(index == 6) { colorrr = '#C19A6B';}
    	if(index == 7) { colorrr = '#ADD8E6';}
...
function opmenu(id) {
    if(id === 1) {
        ...
        $('#menucl').stop(true,true).delay(200).animate({opacity:0});
        $('#menuop').stop(true,true).delay(200).animate({opacity:1});
        $('.header1M1').stop(true,true).delay(200).animate({opacity:1});
        $("#opmenubut").attr("onclick","opmenu(2)");
    } else {

        $('#menuop').stop(true,true).delay(200).animate({opacity:0});
        $('#menucl').stop(true,true).delay(200).animate({opacity:1});
        $('.header1M1').stop(true,true).delay(200).animate({opacity:0});
